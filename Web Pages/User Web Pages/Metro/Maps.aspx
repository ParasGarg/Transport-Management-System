<%@ Page Title="" Language="C#" MasterPageFile="~/Master Pages/Metro.master" AutoEventWireup="true" CodeFile="Maps.aspx.cs" Inherits="User_Web_Pages_Metro_Default" %>
...
<div id="venue_grid" align="right" style="margin-left: 16%">
    ...
    <asp:Image ID="img_direction" runat="server" Height="400px" style="margin-right: 13%; margin-left: 0px;" Width="73%" ImageUrl='<%# Bind("Maps") %>'/>
