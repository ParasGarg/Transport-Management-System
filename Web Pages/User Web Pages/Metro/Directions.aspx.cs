...
public partial class User_Web_Pages_Metro_Default : System.Web.UI.Page
{
    ...
    {    
        cmd = new SqlCommand("SELECT Direction FROM tbl_admin_metro WHERE Source='"+ ddl_source.SelectedValue +"' AND Destination='"+ ddl_destination.SelectedValue +"' ", con);
        cmd.Connection.Open();
        ...
        if (dr.Read())
        {
            ...
            img_direction.ImageUrl = dr["Direction"].ToString();
        }
