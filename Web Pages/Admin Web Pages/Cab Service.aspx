<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cab Service.aspx.cs" Inherits="Default" %>
...
<body>
 ...
 <form id="form" runat="server">
    ...
    <table class="style1">
        ...
        <tr>
            <td>
                <asp:GridView ID="gv_cab_service" runat="server" AllowSorting="True" 
                    AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" 
                    TabIndex="-1" style="text-align: center" Width="1060px"  
                    onrowcommand="gv_cab_service_RowCommand" AllowPaging="True" 
                    onpageindexchanging="gv_cab_service_PageIndexChanging">
